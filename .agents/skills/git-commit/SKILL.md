...
2. Current git diff: !`git diff HEAD`
3. Recent commits: !`git log --oneline -5`
4. Check if CHANGELOG.md needs updating — for user-facing changes (new features, bug fixes,
   breaking changes), always update the changelog first
