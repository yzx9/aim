...
pub struct PropertySpec<'a> {
    pub name: &'a str,
    pub default_kind: ParamValueType,
    #[allow(dead_code)]
    pub allowed_kinds: &'a [ParamValueType],
    #[allow(dead_code)]
...
pub static PROPERTY_SPECS: &[PropertySpec] = &[
    ...
    PropertySpec {
        name: KW_ATTACH,
        default_kind: ParamValueType::Uri,
        allowed_kinds: &[ParamValueType::Uri, ParamValueType::Binary],
        multiple_valued: true,
    },
    // Sect 3.8.1.2. Categories - Comma-separated text values for classification
    PropertySpec {
        name: KW_CATEGORIES,
        default_kind: ParamValueType::Text,
        allowed_kinds: &[ParamValueType::Text],
        multiple_valued: true,
    },
    ...
    PropertySpec {
        name: KW_GEO,
        default_kind: ParamValueType::Float,
        allowed_kinds: &[ParamValueType::Float],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        ...
        default_kind: ParamValueType::Integer,
        allowed_kinds: &[ParamValueType::Integer],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        name: KW_COMPLETED,
        default_kind: ParamValueType::DateTime,
        allowed_kinds: &[ParamValueType::DateTime],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        name: KW_DTEND,
        default_kind: ParamValueType::DateTime,
        allowed_kinds: &[ParamValueType::Date, ParamValueType::DateTime],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        name: KW_DURATION,
        default_kind: ParamValueType::Duration,
        allowed_kinds: &[ParamValueType::Duration],
        multiple_valued: false,
    },
    // Sect 3.8.2.6. Free/Busy Time - One or more free/busy time intervals (VFREEBUSY only)
    PropertySpec {
        name: KW_FREEBUSY,
        default_kind: ParamValueType::Period,
        allowed_kinds: &[ParamValueType::Period],
        multiple_valued: true,
    },
    ...
    PropertySpec {
        ...
        default_kind: ParamValueType::UtcOffset,
        allowed_kinds: &[ParamValueType::UtcOffset],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        name: KW_TZURL,
        default_kind: ParamValueType::Uri,
        allowed_kinds: &[ParamValueType::Uri],
        multiple_valued: false,
    },
    // Sect 3.8.4.1. Attendee - Defines an attendee within a calendar component
    PropertySpec {
        name: KW_ATTENDEE,
        default_kind: ParamValueType::CalendarUserAddress,
        allowed_kinds: &[ParamValueType::CalendarUserAddress],
        multiple_valued: true,
    },
    ...
    PropertySpec {
        ...
        allowed_kinds: &[
            ParamValueType::Date,
            ParamValueType::DateTime,
            ParamValueType::Period,
        ],
        multiple_valued: true,
    },
    ...
    PropertySpec {
        name: KW_RRULE,
        default_kind: ParamValueType::RecurrenceRule,
        allowed_kinds: &[ParamValueType::RecurrenceRule],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        name: KW_TRIGGER,
        default_kind: ParamValueType::Duration,
        allowed_kinds: &[ParamValueType::Duration, ParamValueType::DateTime],
        multiple_valued: false,
    },
