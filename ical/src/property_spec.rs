...
pub struct PropertySpec<'a> {
    pub name: &'a str,
    pub default_kind: ValueKind,
    #[allow(dead_code)]
    pub allowed_kinds: &'a [ValueKind],
    #[allow(dead_code)]
...
pub static PROPERTY_SPECS: &[PropertySpec] = &[
    ...
    PropertySpec {
        name: KW_ATTACH,
        default_kind: ValueKind::Uri,
        allowed_kinds: &[ValueKind::Uri, ValueKind::Binary],
        multiple_valued: true,
    },
    // Sect 3.8.1.2. Categories - Comma-separated text values for classification
    PropertySpec {
        name: KW_CATEGORIES,
        default_kind: ValueKind::Text,
        allowed_kinds: &[ValueKind::Text],
        multiple_valued: true,
    },
    ...
    PropertySpec {
        name: KW_GEO,
        default_kind: ValueKind::Float,
        allowed_kinds: &[ValueKind::Float],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        ...
        default_kind: ValueKind::Integer,
        allowed_kinds: &[ValueKind::Integer],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        name: KW_COMPLETED,
        default_kind: ValueKind::DateTime,
        allowed_kinds: &[ValueKind::DateTime],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        name: KW_DTEND,
        default_kind: ValueKind::DateTime,
        allowed_kinds: &[ValueKind::Date, ValueKind::DateTime],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        name: KW_DURATION,
        default_kind: ValueKind::Duration,
        allowed_kinds: &[ValueKind::Duration],
        multiple_valued: false,
    },
    // Sect 3.8.2.6. Free/Busy Time - One or more free/busy time intervals (VFREEBUSY only)
    PropertySpec {
        name: KW_FREEBUSY,
        default_kind: ValueKind::Period,
        allowed_kinds: &[ValueKind::Period],
        multiple_valued: true,
    },
    ...
    PropertySpec {
        ...
        default_kind: ValueKind::UtcOffset,
        allowed_kinds: &[ValueKind::UtcOffset],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        name: KW_TZURL,
        default_kind: ValueKind::Uri,
        allowed_kinds: &[ValueKind::Uri],
        multiple_valued: false,
    },
    // Sect 3.8.4.1. Attendee - Defines an attendee within a calendar component
    PropertySpec {
        name: KW_ATTENDEE,
        default_kind: ValueKind::CalendarUserAddress,
        allowed_kinds: &[ValueKind::CalendarUserAddress],
        multiple_valued: true,
    },
    ...
    PropertySpec {
        name: KW_RDATE,
        default_kind: ValueKind::DateTime,
        allowed_kinds: &[ValueKind::Date, ValueKind::DateTime, ValueKind::Period],
        multiple_valued: true,
    },
    // Sect 3.8.5.3. Recurrence Rule - Rule or repeating pattern for recurring items
    PropertySpec {
        name: KW_RRULE,
        default_kind: ValueKind::RecurrenceRule,
        allowed_kinds: &[ValueKind::RecurrenceRule],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        name: KW_TRIGGER,
        default_kind: ValueKind::Duration,
        allowed_kinds: &[ValueKind::Duration, ValueKind::DateTime],
        multiple_valued: false,
    },
