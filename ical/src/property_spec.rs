...
pub static PROPERTY_SPECS: &[PropertySpec] = &[
    ...
    PropertySpec {
        name: KW_ATTACH,
        default_kind: PropertyValueKind::Uri,
        allowed_kinds: &[PropertyValueKind::Uri, PropertyValueKind::Binary],
    ...
    PropertySpec {
        name: KW_GEO,
        default_kind: PropertyValueKind::Float,
        allowed_kinds: &[PropertyValueKind::Float],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        ...
        default_kind: PropertyValueKind::Integer,
        allowed_kinds: &[PropertyValueKind::Integer],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        ...
        allowed_kinds: &[PropertyValueKind::DateTime],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        name: KW_FREEBUSY,
        default_kind: PropertyValueKind::Period,
        allowed_kinds: &[PropertyValueKind::Period],
        multiple_valued: true,
    },
    ...
    PropertySpec {
        ...
        default_kind: PropertyValueKind::UtcOffset,
        allowed_kinds: &[PropertyValueKind::UtcOffset],
        multiple_valued: false,
    },
    ...
    PropertySpec {
        name: KW_TZURL,
        default_kind: PropertyValueKind::Uri,
        allowed_kinds: &[PropertyValueKind::Uri],
        multiple_valued: false,
    },
    // Sect 3.8.4.1. Attendee - Defines an attendee within a calendar component
    PropertySpec {
        name: KW_ATTENDEE,
        default_kind: PropertyValueKind::CalendarUserAddress,
        allowed_kinds: &[PropertyValueKind::CalendarUserAddress],
        multiple_valued: true,
    },
    ...
    PropertySpec {
        name: KW_TRIGGER,
        default_kind: PropertyValueKind::Duration,
        allowed_kinds: &[PropertyValueKind::Duration, PropertyValueKind::DateTime],
        multiple_valued: false,
    },
