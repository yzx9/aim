...
- build: Bump rand from 0.9.2 to 0.9.4 (Dependabot security alert #13)
...
- core: Multi-calendar support
  ...
  - `CalendarConfig` and `Calendars` modules for calendar configuration and CRUD operations
  - `Store` trait with `LocalStore` and `CaldavStore` implementations for calendar store
...
- core: Parse month day as datetime anchor
...
- cli: Update json output format for event and todo commands
- cli: Highlight todos overdue today in bright red
- cli: Replace line feed char

### Deprecated

- cli: Hide verbose option
...
- cli: Auto hide titles for command `delay` and `reschedule`
- core: Find next suggested time for today in `DateTimeAnchor`

### Fixed

- cli: Check fields correctly in command `edit`
...
- cli: Add toplevel `delay` and `reschedule` command
...
[Unreleased]: https://github.com/yzx9/aim/compare/v0.12.1...HEAD
[v0.12.1]: https://github.com/yzx9/aim/compare/v0.12.0...v0.12.1
[v0.12.0]: https://github.com/yzx9/aim/compare/v0.11.0...v0.12.0
[v0.11.0]: https://github.com/yzx9/aim/compare/v0.10.0...v0.11.0
[v0.10.0]: https://github.com/yzx9/aim/compare/v0.9.2...v0.10.0
